...
$(function() {
var dropzoneExistance = new Dropzone("div#droparea", {
    url: "/uploadajax",
    ...
    addRemoveLinks : true,
    maxFiles: 1,
    hiddenInputContainer: "#previewsContainer .addfile",
    renderMethod: "prepend",
    dictDefaultMessage: "Add Photo",
    clickable : "#previewsContainer .addfile",
  ...
  dropzoneExistance.options.previewTemplate = '\
  ...
  dropzoneExistance.options.dictRemoveFile  = '\
    <div class="remove" data-dz-remove>\
      <i class="glyphicon glyphicon-remove"></i>\
    </div>';

  /* receive the "file" as first parameter */
  dropzoneExistance.on("addedfile", function(file) {
